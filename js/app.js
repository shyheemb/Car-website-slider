...
let startSliding = () => {
  ...
  setInterval (() => {
 //remove from active from first and add it to the second 
 //slide so it cam become the first slide with the class activated  
